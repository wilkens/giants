...
# URLs for data
standings_url = "https://giantsdata.s3.amazonaws.com/data/standings/giants_standings_1958_present.parquet"
batting_url = "https://giantsdata.s3.amazonaws.com/data/batting/giants_team_batting_1958_present.parquet"
pitching_url = 'https://giantsdata.s3.amazonaws.com/data/pitching/giants_pitching_totals_current.parquet'
pitching_ranks_url = 'https://giantsdata.s3.amazonaws.com/data/pitching/giants_pitching_ranks_current.parquet'
batting_ranks_url = 'https://giantsdata.s3.amazonaws.com/data/batting/giants_team_batting_ranks_1958_present.parquet'
...
save_to_s3(summary_df, "data/standings/season_summary_latest", "giantsdata")
