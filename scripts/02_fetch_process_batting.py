...
player_totals_archive_df = pd.read_parquet(
    "https://giantsdata.s3.amazonaws.com/data/batting/archive/giants_player_batting_statistics_1958_2023.parquet"
)
...
team_totals_archive_df = pd.read_parquet(
    "https://giantsdata.s3.amazonaws.com/data/batting/archive/giants_team_batting_statistics_1958_2023.parquet"
)
...
team_ranks_archive_df = pd.read_parquet(
    "https://giantsdata.s3.amazonaws.com/data/batting/archive/giants_team_batting_rankings_1958_2023.parquet"
)
...
save_to_s3(
    players_full_df,
    "data/batting/giants_player_batting_1958_present",
    "giantsdata",
)
save_to_s3(
    team_full_df,
    "data/batting/giants_team_batting_1958_present",
    "giantsdata",
)
save_to_s3(
    team_ranks_full_df,
    "data/batting/giants_team_batting_ranks_1958_present",
    "giantsdata",
)
