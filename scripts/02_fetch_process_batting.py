...
player_totals_archive_df = pd.read_parquet(
    "http://giantsdata.s3.amazonaws.com/giants/data/batting/archive/giants_player_batting_statistics_1958_2023.parquet"
)
...
team_totals_archive_df = pd.read_parquet(
    "http://giantsdata.s3.amazonaws.com/giants/data/batting/archive/giants_team_batting_statistics_1958_2023.parquet"
)
...
team_ranks_archive_df = pd.read_parquet(
    "http://giantsdata.s3.amazonaws.com/giants/data/batting/archive/giants_team_batting_rankings_1958_2023.parquet"
)
